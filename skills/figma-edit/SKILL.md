...
- **[references/tool-selection.md](references/tool-selection.md)** — choosing among overlapping tools, `node_info` field selection (fast vs slow), batch vs single, and streaming progress.

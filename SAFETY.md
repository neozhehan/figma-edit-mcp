...
>
> **Applies to: v2.3.3.** It describes the current enforcement state — the v2.1.0/v2.2.0/v2.3.0/v2.3.1 scope-lock and name-verification model, the v2.3.2 dispatcher/component-set/creation hardening, and v2.3.3's universal existing-object verification, truthful batch outcomes, recursive strictness, contained creation, peer-bound routing, and page-load isolation. Bare `§N` references point into the [v2.2.0 PRD](planning/completed/v2.2.0-safety-enhancement/prd.md), where those structural guards were specified; sections tagged with a release version point into that release's PRD.
>
...
- Cross-references: holistic agent guidance → `constraints.md`; per-error recovery → `error-playbook.md`; the v2.3.2 change rationale → [`prd.md`](planning/completed/v2.3.2-safety-contract-conformance-&-atomicity-hardening/prd.md) (v2.3.1: [`prd.md`](planning/completed/v2.3.1-bind-variable-guardrails/prd.md)); review provenance → [`figma-documentation-check.md`](planning/completed/v2.2.0-safety-enhancement/figma-documentation-check.md) and [`critique.md`](planning/completed/v2.3.1-bind-variable-guardrails/critique.md).

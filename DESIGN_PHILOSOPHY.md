...
- The AI model reaches the artifact only through a request, so **what the AI tool lets a request express** is the only thing that limits what the AI model can ask for.

...
#### [MODIFY] [server.ts](file:///Users/neozhehan/Git/figma-edit-mcp/src/mcp_server/server.ts)
- Remove all inline `server.tool(...)` calls.
- Import `registerAllTools` from `./tools/index.js`.
- Call `registerAllTools(server)`.

#### [MODIFY] [package.json](file:///Users/neozhehan/Git/figma-edit-mcp/package.json)
- Add `jest`, `ts-jest`, `@types/jest` to devDependencies.
- Add `test` script: `jest`.

#### [NEW] [jest.config.js](file:///Users/neozhehan/Git/figma-edit-mcp/jest.config.js)
- Configure Jest to use `ts-jest` for TypeScript files.
- Map `src/*` paths if necessary.

#### [DELETE] [tools.ts](file:///Users/neozhehan/Git/figma-edit-mcp/src/mcp_server/tools.ts)
- This file content will be distributed to `document.ts` and `creation.ts`.

#### [NEW] [src/mcp_server/tools/index.ts](file:///Users/neozhehan/Git/figma-edit-mcp/src/mcp_server/tools/index.ts)
- Exports `registerAllTools(server: McpServer)`.
- Imports register functions from all sub-modules and calls them.

#### [NEW] [src/mcp_server/tools/creation.ts](file:///Users/neozhehan/Git/figma-edit-mcp/src/mcp_server/tools/creation.ts)
- `create_rectangle`
- `create_frame`
- `create_node_from_svg`
- `create_connections` (Note: comparative analysis puts this in Prototyping, we will verify)

#### [NEW] [src/mcp_server/tools/modification.ts](file:///Users/neozhehan/Git/figma-edit-mcp/src/mcp_server/tools/modification.ts)
- `move_node`
- `resize_node`
- `set_node_name`
...
#### [NEW] [src/mcp_server/tools/styling.ts](file:///Users/neozhehan/Git/figma-edit-mcp/src/mcp_server/tools/styling.ts)
- `set_fill_color`
- `set_stroke_color`
- `set_corner_radius`
- `set_effects`
...
#### [NEW] [src/mcp_server/tools/text.ts](file:///Users/neozhehan/Git/figma-edit-mcp/src/mcp_server/tools/text.ts)
- `create_text`
- `set_text_content`
- `set_multiple_text_contents`
- `scan_text_nodes`

#### [NEW] [src/mcp_server/tools/layout.ts](file:///Users/neozhehan/Git/figma-edit-mcp/src/mcp_server/tools/layout.ts)
- `set_layout_mode`
- `set_padding`
- `set_axis_align`
- `set_layout_sizing`
...
#### [NEW] [src/mcp_server/tools/components.ts](file:///Users/neozhehan/Git/figma-edit-mcp/src/mcp_server/tools/components.ts)
...
#### [NEW] [src/mcp_server/tools/variables.ts](file:///Users/neozhehan/Git/figma-edit-mcp/src/mcp_server/tools/variables.ts)
- `get_variables`
- `get_node_variables`
- `set_bound_variable`
- `manage_variables`

#### [NEW] [src/mcp_server/tools/annotations.ts](file:///Users/neozhehan/Git/figma-edit-mcp/src/mcp_server/tools/annotations.ts)
- `get_annotations`
- `set_multiple_annotations`

#### [NEW] [src/mcp_server/tools/prototyping.ts](file:///Users/neozhehan/Git/figma-edit-mcp/src/mcp_server/tools/prototyping.ts)
- `get_reactions`
- `set_default_connector`
- `create_connections`

#### [NEW] [src/mcp_server/tools/document.ts](file:///Users/neozhehan/Git/figma-edit-mcp/src/mcp_server/tools/document.ts)
- `get_document_info`
- `get_page_info`
- `get_nodes_info`
- `scan_nodes_by_types`
...
#### [NEW] [src/mcp_server/tools/assets.ts](file:///Users/neozhehan/Git/figma-edit-mcp/src/mcp_server/tools/assets.ts)
- `export_node_as_image`

#### [NEW] [tests/unit/tools/*.test.ts](file:///Users/neozhehan/Git/figma-edit-mcp/tests/unit/tools/)

...
- [ ] **Quick Start (replace lines 34-89)**:
...
- [ ] **Integration-Specific Setup (replace lines 91-124)**:
...
- [ ] **Manual Configuration (replace lines 128-149)**:
...
- [ ] **Development Setup → Contributing (replace lines 155-186)**:
...
- [ ] **Windows + WSL Guide (replace lines 190-209)**:
...
- [ ] **Final sweep — remove all legacy clone references**:

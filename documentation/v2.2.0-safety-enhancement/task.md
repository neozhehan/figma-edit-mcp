...
- [x] **Live Verification:** Build the plugin; in Figma confirm the checkboxes enable/disable node, variable, and style edits independently, are disabled while connected, and that a linked-but-asset-unchecked session blocks asset edits.
